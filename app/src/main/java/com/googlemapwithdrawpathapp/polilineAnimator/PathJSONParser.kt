...
class PathJSONParser {
    ...
    fun parse(jObject: JSONObject): List<List<HashMap<String, String>>> {
        ...
        try {
            ...
            for (i in 0 until jRoutes!!.length()) {
                ...
                val mJsonObject = jLegs!!.getJSONObject(i).optJSONObject("duration")

                duration = mJsonObject!!.getString("text")


                val mJsonObjectdistance = jLegs.getJSONObject(i).optJSONObject("distance")
    ...
    fun getDuration(jObject: JSONObject): String? {
        val routes = ArrayList<List<HashMap<String, String>>>()
        var jRoutes: JSONArray? = null
        var jLegs: JSONArray? = null
        val jSteps: JSONArray? = null
        var duratuion: String? = null
